...
assert(renderer.includes('blockRealExecution solo protege el training'), 'Training debe declarar que su bloqueo protege el loop paper sin bloquear gates manuales reales.');
...
assert(main.includes("'MT5_PYTHON_COMMAND'"), 'MT5 debe permitir configurar un wrapper Wine/Python por entorno o por usuario.');
assert(main.includes('runPythonJson'), 'MT5 debe ejecutar Python con timeout externo para no dejar endpoints cargando infinito.');
assert(main.includes('MT5_PYTHON_TIMEOUT_MS'), 'MT5 debe tener timeout defensivo para procesos Python colgados.');
